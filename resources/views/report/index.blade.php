            ...
            <div class="container mx-auto px-4">
                ...
                <div class="bg-[#ffffff] rounded-xl mb-3 space-y-4 p-4 md:p-7">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center">
                        <span class="text-[14px] md:text-[16px] mb-2 sm:mb-0">{{__('Сортировка по дате создания:')}}</span>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center">
                        <p class="text-[14px] md:text-[16px] mb-2 sm:mb-0">{{__('Фильтрация по статусу заявки:')}}</p>
                    ...
                    <form method="POST" action="{{ route('reports.update', $report->id) }}">
                        ...
                        <div class="bg-[#ffff] mb-3 space-y-4 p-4 md:p-7 rounded-xl">
                            ...
                            <div class="flex flex-wrap items-center">
                                <p class="text-[14px] md:text-[16px]">{{__('Статус заявления')}} -</p>
